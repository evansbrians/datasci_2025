...
The `cicadas_2021.rds` file represents research-grade iNaturalist observations of Brood X periodical cicadas from February through September of 2021.
...
* [[0.25]]{.subscore} The `address` variable contains "park" or "Park";
