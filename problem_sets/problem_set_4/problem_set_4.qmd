...
8\. [[2.0]]{.score} Using `brood_x_parks`, generate a summary table that:
...
* Generate a density plot, in which:
  ...
  * The geometry of the plot represents the statistical density of species observations, with each species displayed on top of one another (i.e., "stacked");
  ...
  * The scale of the y-axis for a given park ranges from 0 to a value of 0.05 above the maximum density for that park;
