...
* [branch_id]{.mono}, character: A unique identifier for each survey location (primary key).
* [survey_location]{.mono}, character: A unique letter code input by users that specifies a particular survey branch.
