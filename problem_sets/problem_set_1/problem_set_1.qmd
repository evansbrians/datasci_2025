...
:::{class="mysecret"}
<i class="fas fa-user-secret fa-2x" style="padding-right: 6px;"></i>  It pays to keep track of when a function was first used (or used elsewhere in new ways). The answers to bullet points 1-3 was covered in the tutorial ***1.3 R Objects*** and the answer to bullet point 4 was covered in ***1.5 Assignments***.
:::
