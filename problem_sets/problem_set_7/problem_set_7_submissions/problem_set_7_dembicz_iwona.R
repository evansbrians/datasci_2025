...
# Answer: I have tried, but the code is generating three 'empty' plots...
...
size_and_volume %>% 
  mutate(species = 
    case_when(size < 10 & volume <= 30 ~ "Deer mouse",
