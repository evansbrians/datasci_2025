...
# lifelines file for reference as needed:

# lifelines <-
#   read_rds("data/raw/problem_set_6_lifelines.rds")
...
banding <- 
  ...
  # join visits to resulting table from above
...
banding_subset <- 
  ...
  # subset to observations where age and sex are known
  ...
  # subset to observations with reasonable mass and wind measurements
  ...
  # categorize and label age classes
