...
# subset to observations where sex and age is known 
    
    !if_any(
      age:sex, 
      ~ .x == "U"),

# subset to observations where "wing" measurements > 40 mm and "mass" measurements > 7 g

    wing > 40,
    mass > 7) %>%

# Modify the "age" variable so age classes are a factor variable with the levels "juvenile" and "adult"
