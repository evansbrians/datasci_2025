...
coqui_coord_fix <- 
  ...
  # Separate longitude and latitude into to two variables
...
coqui_long <- 
  ...
  # tidy the data to have a single column of coqui count
...
# [[-0.25]] Incorrect: The counted the number of observations per transect and
# habitat type.
...
# Violation of tidy rule number three that each level of observation forms a 
# table.
# I noticed repeated values of the variables site, longitude, latitude, habitat, 
# transect_id and distance class across multiple rows. The table consist of 
# observations associated with coqui count,observations associated with site 
# characteristics and observations associated with the transects so they should 
