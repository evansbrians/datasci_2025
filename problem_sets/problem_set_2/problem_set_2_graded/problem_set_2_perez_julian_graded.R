...
# [[No points removed]] Code formatting: Indentation is off after the assignment
# operator.
...
# [[-0.25]] `table` and `$` are not among the functions that you may use for
# this assignment.
...
# [[-0.25]] Incorrect: Fill color was to be determined by site, not habitat.
...
# [[-0.125]] Incorrect (bullet point 4): You left a pipe at the end of your code
# block.
