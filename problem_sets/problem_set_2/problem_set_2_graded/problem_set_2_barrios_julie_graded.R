...
# [[-0.25]] `summarise` is not among the functions that you may use for this
# assignment.
...
# [[-0.025]] Code formatting (bullet point 2): Maintain one blank line between
...
# The second rule is being violated with the columns describing the coordinates 
# of the sites. That information is better as a second table because their value
# will not change unless the site changes. The transect_id and dates would change 
# but the site and coordinates would not. 
