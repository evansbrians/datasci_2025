...
-   **Module 2: Introduction to the tidyverse** (24 - 30 Mar): You will learn what tidy data is and the primary tidyverse tools for managing and visualizing ecological data.
-   **Module 3: Working with tidy data** (31 Mar - 6 Apr): This module provides the core tools for effectively working with tidy data, including adding or modifying columns, summarizing, subsetting with logic, and joining data across tables.
-   **Module 4: Focus on subsetting**  (7 - 13 Apr): Here, we will explore all things subsetting, including iterative subsetting operations, filtering strings, dates and times, and subsetting vectors.
-   **Module 5: Focus on mutation** (14 - 20 Apr): Lorem ipsum.
-   **Module 6: Programming I**  (21 - 27 Apr): Lorem ipsum.
-   **Module 7: Programming II** (*Optional*; 28 Apr - 4 May): Lorem ipsum.
-   **Module 8: Communicating data** (*Optional*; 5 - 11 May): Lorem ipsum.
