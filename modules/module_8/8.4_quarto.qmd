...
We can define a style using CSS by adding a CSS code chunk. Similar to adding an R code chunk, the chunk is defines by opening and closing triple backtick quotes. Inside of curly braces you specify that you are adding CSS.
