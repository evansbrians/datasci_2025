...
To convert the Markdown document to HTML, we need to knit the document. There are a few options for this.
...
Typically, though, I often click the checkbox "Render on Save" and then knit the document with the keyboard shortcut Control (Windows) or command (Mac) + shift + S:
