...
If we want to include our code and its output, we can create a "code chunk" with:

``` {r}

```

To include only the output of our code, but not the code itself, we can specify `echo=FALSE`:
