...
-   **7.1. Memory and time**: This video lesson (runtime -- 19:39) and (brief) written tutorial introduces the concept of evaluating memory usage and processing time of a given process. As we get into big data (or coding web applications), understanding memory usage becomes *super* important!
