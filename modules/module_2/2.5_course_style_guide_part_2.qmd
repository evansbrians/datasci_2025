---
title: "2.5 Course style guide, part 2"
format:
  html:
    embed-resouces: true
    self-contained: true
...
Welcome to the second style guide of this course! Now that your coding knowledge has expanded, we have the opportunity to improve our coding syntax even further in our quest to create communicable, readable code. Well-formatted code is not just an end product though -- recommendations in this document will help you explore and debug your code *as you write it*. Moreover, a portion of your grade for problem set 2 will be based on adhering to this style guide (up to 10% per problem set)!
...
This lesson provides more code formatting rules that we will follow in this course. I suggest returning to this *often* and comparing your problem set 2 answers with this guide prior to submission. I provide a description of the code formatting rules, examples of each, and any exceptions to the rules.
...
The "Additions" section, below, only includes new formatting rules that were not present in **Lesson 1.6: Course style guide, part 1**. The "Style guide" section is a comprehensive list of all our formatting rules thus far.
...
-   **Nested functions** should not be nested deeper than two levels (use a pipe instead!).
