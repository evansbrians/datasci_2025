...
-   **3.1. Review of tidy data**: Here, we will review the rules that govern tidy data and we will practice transitioning from assignments to piped code while we tidy a very messy dataset. *Do not skip this lesson, as you will write the data to your hard drive and use those data for many of the lessons below!*
