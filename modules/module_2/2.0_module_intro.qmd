...
-   **2.4 Introduction to data visualization with ggplot**: We will be visualizing data a lot throughout this course. To do so, we will use the tidyverse package, ggplot (a core package).
