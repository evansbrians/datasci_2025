---
title: "4.1 Data visualization with ggplot, part two"
format:
  html:
    embed-resouces: true
    self-contained: true
...
In this lesson we will continue our exploration of using the core tidyverse package *ggplot* to visualize data. In this written lesson (no video) we will use two datasets to generate a series of plots. The lesson is broken down into two main sections:

1. Create plots based on the goals of a given visualization (and/or research questions), adding new content along the way;
2. A data visualization "grimoire" in which we will summarize the plotting features above.
...
We will use three datasets for this lesson. Please load them with the following script:
...
co2 <-
  read_rds("data/raw/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_2764620.rds")
```


## Addressing questions with data visualization



## Data visualization grimoire
...
Please open the `data_sci_2025` project in R Studio.
