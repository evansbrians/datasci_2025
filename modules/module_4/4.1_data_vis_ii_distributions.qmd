...
## Geometries for exploring distributions

### Binned continuous variables: `geom_histogram`
...
### The statistical density of continuous distributions: `geom_density`
...
### Statistical summaries of continuous distributions: `geom_boxplot`

Sometimes, we are more interested in core summary statistics that describe a distribution than the distribution itself. For this, we use `geom_boxplot`.

Let's look at our distribution of wing lengths using a box plot by mapping `spp` to the x-axis, `wing` to the y-axis, and adding the geometry `geom_boxplot()`:
