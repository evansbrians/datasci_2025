...
Density plots are great for comparing distributional differences among groups.
...
I typically do not use histograms to compare the distribution of two or more grouping variables, so I will focus our attention in this section on boxplots and statistical density plots.
...
Difficult to compare due to outliers across species, let's set the range of wing length to between 45 and 70 mm:
...
Violin plots provide a clear visualization for comparing for differences in distributions across multiple groups. They are great for comparing the shapes of distributions between groups.
...
Violin plats are actually density plots, but the right- and left-hand sides of the violin are mirrored density distributions. Note, however, that the values of density in this violin plots are not shown, just the shape of the distribution.
