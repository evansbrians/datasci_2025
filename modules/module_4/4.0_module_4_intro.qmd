...
Please download the attached zip file [module_4_files.zip]{.mono} and place any R script files ([*.R]{.mono}) in the [data_sci/scripts]{.mono} folder. If there are any script or data files that you already have, please overwrite the previous file.
