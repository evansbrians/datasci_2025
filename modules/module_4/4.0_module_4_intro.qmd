...
-   **4.4. Subsetting vectors**:  In the final video lesson (runtime -- 25:56) and compendium tutorial we will address how to subset vectors (atomic vectors and lists) by position, name, and logic.
